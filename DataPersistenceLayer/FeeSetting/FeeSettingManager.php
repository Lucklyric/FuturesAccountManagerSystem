<?php
    ...
    class FeeSettingManager {
        ...
        function GetAllData($userid,$password)
        {
            ...
            //$next="abc";
            //return $next;
            $data = array("userid"=>$userid,"password"=>$password,"tablename" => "feesetting");
        ...
        function GetCommissionFeeMultiplier()
        {
            ...
            $data_string = json_encode($data);
            $ch = curl_init('121.40.131.144/SPService/SPService.svc/     GetCommissionFeeMultiplier');
            curl_setopt($ch, CURLOPT_CUSTOMREQUEST, "POST");
            curl_setopt($ch, CURLOPT_POSTFIELDS, $data_string);
            curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
            curl_setopt($ch, CURLOPT_HTTPHEADER, array(
        ...
        function GetMarginRateMultiplier()
        {
            ...
            $data = array("port" => "10083");
            $data_string = json_encode($data);
            $ch = curl_init('121.40.131.144/SPService/SPService.svc/     GetMarginRateMultiplier');
            curl_setopt($ch, CURLOPT_CUSTOMREQUEST, "POST");
            curl_setopt($ch, CURLOPT_POSTFIELDS, $data_string);
            curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
            curl_setopt($ch, CURLOPT_HTTPHEADER, array(
